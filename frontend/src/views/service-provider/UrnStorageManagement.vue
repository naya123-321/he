<template>
  <div class="urn-storage-management-container">
    <el-page-header @back="goBack" content="骨灰寄存管理（服务人员）" />
...
const rowActionLoading = reactive<Record<number, { approving?: boolean; rejecting?: boolean; retrieving?: boolean }>>({});
function setRowLoading(id: number, key: "approving" | "rejecting" | "retrieving", val: boolean) {
